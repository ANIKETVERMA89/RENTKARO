...
const testimonials = [
  {
    id: 1,
    quote: "RentKaro made my weekend trip to the hills absolutely seamless. The vehicle was in pristine condition and the process was faster than I expected.",
    author: "Arjun Mehta",
    role: "Regular Renter",
  ...
  {
    id: 2,
    quote: "As an individual owner, I was worried about security, but the verification process and insurance coverage gave me peace of mind. Highly recommended!",
    author: "Sneha Rao",
    role: "Vehicle Owner",
  ...
  {
    id: 3,
    quote: "The best rental platform I've used. The 'Noir' interface is slick, and being able to choose between hourly and daily rates is a game-changer.",
    author: "Vikram Singh",
...
export function Testimonials() {
  ...
  return (
    <div className="flex flex-col items-center gap-10 py-32 bg-background relative z-10">
      {/* Quote Container */}
      <div className="relative px-8">
        ...
        <p
          className={cn(
            "text-2xl md:text-3xl font-light text-foreground text-center max-w-lg leading-relaxed transition-all duration-400 ease-out h-[150px] flex items-center",
